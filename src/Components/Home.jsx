    ...
    <div name="Home" className='h-screen w-full bg-gradient-to-b from-black via-black to-gray-800'>
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row text-white'>
            <div className='flex flex-col justify-center h-full'>
                <h2 className=' mt-14 font-signature pl-2 sm:pl-0  text-5xl sm:text-7xl font-bold sm:font-Roboto text-blue-500 '>Anupam</h2>
                <p className='text-2xl font-Roboto pt-3 pl-20  sm:pl-0 text-white'>A Full Stack Developer</p>
                ...
                <button  className='text-white w-fit m-2 px-6 py-3 flex items-center rounded-md bg-gradient-to-r from-cyan-500 to-blue-500 cursor-pointer hover:scale-110 duration-200 '>
                  <ul>
                    <a href='/Resume.pdf' download ='Anupam-Resume'> Resume</a>
                  </ul>
                </button>
                </div>
            </div>
